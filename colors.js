module.exports.inline = {
  resets:    { '0': false },
  bold:      { '1': { style: 'font-weight:bold' }, '22': false },
  underline: { '4': { style: 'text-decoration:underline' }, '24': false },
  foregrounds: {
...
module.exports.classes = {
  resets:    { '0': false },
  bold:      { '1': { 'class': 'ansi-bold' }, '22': false },
  underline: { '4': { 'class': 'ansi-underline' }, '24': false },
  foregrounds: {
